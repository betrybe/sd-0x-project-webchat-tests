 ...
 */
 ...
 describe('4 - Elabore o histórico do chat para que as mensagens persistam', () => {
   let browser;
   let page;
   let connection;
   let db;
   ...
   it('Será validado que todo o histórico de mensagens irá aparecer quando o cliente se conectar', async () => {
     ...
     client1.emit('listenMessage', firstMessageToSend);
     //typing...
     wait(500)
     client1.emit('listenMessage', secondMessageToSend);
     //typing...
     wait(500)
     client1.emit('listenMessage', thirdMessageToSend);
   ...
   it('Será validado que ao enviar uma mensagem e recarregar a página, a mensagem persistirá', async () => {
     ...
     //typing...
     wait(500)
     client1.emit('listenMessage', messageToSend);
